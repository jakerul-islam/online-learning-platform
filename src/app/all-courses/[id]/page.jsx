import CurriculamList from '@/components/CurriculamList';
...
const CourseDetailsPage = async({params}) => {
   ...
   <div className='flex justify-center items-center'>
         <div className=" max-w-3xl bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition duration-300 border">
