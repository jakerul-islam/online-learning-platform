...
//           <Link href={'/all-courses'}><button className="animate__backInLeft animate__animated w-full sm:w-auto bg-white text-black px-6 py-3 rounded-full font-medium transition duration-300 ease-in-out hover:bg-gray-200 hover:scale-105 active:scale-95">
//             Explore Courses
//           </button></Link>

//           <Link href={'/signup'}><button className="animate__backInRight animate__animated w-full sm:w-auto border  border-gray-500 text-white px-6 py-3 rounded-full transition duration-300 ease-in-out hover:bg-white hover:text-black hover:scale-105 active:scale-95">
//             Get Started
//           </button></Link>
    ...
    <section className="relative min-h-screen flex items-center justify-center text-center px-4 sm:px-6 lg:px-8 overflow-hidden bg-black">
      ...
      <div className="relative z-10 max-w-4xl">
        ...
        <motion.h1
          ...
          className="text-white font-bold leading-tight text-3xl sm:text-4xl md:text-5xl lg:text-6xl"
        >
          Upgrade Your <br className="hidden sm:block" />
          Skills Today 🚀
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-gray-300 mt-4 sm:mt-6 text-sm sm:text-base md:text-lg max-w-xl md:max-w-2xl mx-auto"
        >
          Learn Web Development, Design, Marketing and more from industry experts.
          Build your career with real-world skills.
        </motion.p>
        ...
        >
          ...
          <Link href="/all-courses">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="w-full sm:w-auto bg-white text-black px-6 py-3 rounded-full font-medium"
            >
              Explore Courses
            </motion.button>
          </Link>
          ...
          <Link href="/signup">
            <motion.button
              whileHover={{ scale: 1.08 }}
              whileTap={{ scale: 0.95 }}
              className="w-full sm:w-auto border border-gray-500 text-white px-6 py-3 rounded-full"
            >
              Get Started
            </motion.button>
          </Link>
